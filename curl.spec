...
Source0  : https://github.com/curl/curl/releases/download/curl-8_14_1/curl-8.14.1.tar.gz
Source1  : https://github.com/curl/curl/releases/download/curl-8_14_1/curl-8.14.1.tar.gz.asc
...
%setup -q -n curl-8.14.1
cd %{_builddir}/curl-8.14.1
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a curl-8.14.1 build32
popd
pushd ..
cp -a curl-8.14.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749759603
...
cp %{_builddir}/curl-%{version}/COPYING %{buildroot}/usr/share/package-licenses/curl/792623e2d6c9d0891b7d6d0c19e728dadb0859df || :
export GOAMD64=v2
pushd ../build32/
%make_install32
...
/usr/share/man/man3/CURLOPT_CA_CACHE_TIMEOUT.3
...
/usr/share/package-licenses/curl/792623e2d6c9d0891b7d6d0c19e728dadb0859df
