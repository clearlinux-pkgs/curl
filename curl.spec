...
Source0  : https://github.com/curl/curl/releases/download/curl-8_9_0/curl-8.9.0.tar.gz
Source1  : https://github.com/curl/curl/releases/download/curl-8_9_0/curl-8.9.0.tar.gz.asc
...
%setup -q -n curl-8.9.0
cd %{_builddir}/curl-8.9.0
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
pushd ..
cp -a curl-8.9.0 build32
popd
pushd ..
cp -a curl-8.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721846516
